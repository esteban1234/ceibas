...
<html lang="es">
  ...
  <title>CEIBAS</title>
   <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0"> 
    <META NAME="Title" content="CEIBAS">
    <META NAME="Author" CONTENT="[http://zizilche.com/]"/>
    <META name="Description" content="Lotes de Inversión"/>
    <META NAME="Keywords" CONTENT="casas en venta, venta de casas, terrenos en venta, departamentos en venta, Morelia, Colima, Tabasco, Mérida, Querétaro, La laguna, casas CEIBAS, terrenos CEIBAS, club CEIBAS, golf"/>
